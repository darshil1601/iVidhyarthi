  ...
  try {
    if (!isConnected) {
      return res.status(503).json({
        success: false,
        message:
          "Database not available. File upload requires MongoDB connection.",
        suggestion:
          "Try using a mobile hotspot or check network/firewall settings.",
      });
    }
  ...
  try {
    if (!isConnected) {
      return res.status(503).json({
        success: false,
        message:
          "Database not available. File listing requires MongoDB connection.",
        suggestion:
          "Try using a mobile hotspot or check network/firewall settings.",
      });
    }
  ...
  try {
    if (!isConnected) {
      return res.status(503).json({
        success: false,
        message:
          "Database not available. File download requires MongoDB connection.",
        suggestion:
          "Try using a mobile hotspot or check network/firewall settings.",
      });
    }
  ...
  try {
    if (!isConnected) {
      return res.status(503).json({
        success: false,
        message:
          "Database not available. File deletion requires MongoDB connection.",
        suggestion:
          "Try using a mobile hotspot or check network/firewall settings.",
      });
    }
